package org.nebulamodding.centaurus.registry.worldgen;
...
public class CBiomes {
    ...
    public static ResourceKey<Biome> create(String name) {
        return ResourceKey.create(Registries.BIOME, ResourceLocation.fromNamespaceAndPath(Centaurus.MOD_ID, name));
    }
}