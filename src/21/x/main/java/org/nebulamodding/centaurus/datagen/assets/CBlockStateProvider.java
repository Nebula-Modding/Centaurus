...
public class CBlockStateProvider extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        simpleBlockWithItem(CBlocks.LUTRUM_WINDOW.get(), models().cubeAll("lutrum_window", blockLoc(CBlocks.LUTRUM_WINDOW)).renderType("translucent"));
    ...
    //private void minecraftBarCode() {
    //    ResourceLocation postEnds = ModelLocationUtils.getModelLocation(Blocks.IRON_BARS, "_post_ends");
    //    ResourceLocation post = ModelLocationUtils.getModelLocation(Blocks.IRON_BARS, "_post");
    //    ResourceLocation cap = ModelLocationUtils.getModelLocation(Blocks.IRON_BARS, "_cap");
    //    ResourceLocation capAlt = ModelLocationUtils.getModelLocation(Blocks.IRON_BARS, "_cap_alt");
    //    ResourceLocation side = ModelLocationUtils.getModelLocation(Blocks.IRON_BARS, "_side");
    //    ResourceLocation sideAlt = ModelLocationUtils.getModelLocation(Blocks.IRON_BARS, "_side_alt");
    //    this.blockStateOutput.accept(MultiPartGenerator.multiPart(Blocks.IRON_BARS).with(
    //            Variant.variant().with(VariantProperties.MODEL, postEnds)).with(Condition.condition().term(BlockStateProperties.NORTH, false).term(BlockStateProperties.EAST, false).term(BlockStateProperties.SOUTH, false).term(BlockStateProperties.WEST, false),
    //            Variant.variant().with(VariantProperties.MODEL, post)).with(Condition.condition().term(BlockStateProperties.NORTH, true).term(BlockStateProperties.EAST, false).term(BlockStateProperties.SOUTH, false).term(BlockStateProperties.WEST, false),
    //            Variant.variant().with(VariantProperties.MODEL, cap)).with(Condition.condition().term(BlockStateProperties.NORTH, false).term(BlockStateProperties.EAST, true).term(BlockStateProperties.SOUTH, false).term(BlockStateProperties.WEST, false),
    //            Variant.variant().with(VariantProperties.MODEL, cap).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90)).with(Condition.condition().term(BlockStateProperties.NORTH, false).term(BlockStateProperties.EAST, false).term(BlockStateProperties.SOUTH, true).term(BlockStateProperties.WEST, false),
    //            Variant.variant().with(VariantProperties.MODEL, capAlt)).with(Condition.condition().term(BlockStateProperties.NORTH, false).term(BlockStateProperties.EAST, false).term(BlockStateProperties.SOUTH, false).term(BlockStateProperties.WEST, true),
    //            Variant.variant().with(VariantProperties.MODEL, capAlt).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90)).with(Condition.condition().term(BlockStateProperties.NORTH, true),
    //            Variant.variant().with(VariantProperties.MODEL, side)).with(Condition.condition().term(BlockStateProperties.EAST, true),
    //            Variant.variant().with(VariantProperties.MODEL, side).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90)).with(Condition.condition().term(BlockStateProperties.SOUTH, true),
    //            Variant.variant().with(VariantProperties.MODEL, sideAlt)).with(Condition.condition().term(BlockStateProperties.WEST, true),
