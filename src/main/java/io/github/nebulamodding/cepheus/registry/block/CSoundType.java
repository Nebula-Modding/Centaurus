...
public class CSoundType {
    ...
    public static final DeferredSoundType METAL_GRATE = new DeferredSoundType(
            1.0F,
            1.5F,
    ...
    public static final DeferredSoundType METAL_WINDOW = new DeferredSoundType(
            1.0F,
            1.5F,
    ...
    public static final DeferredSoundType METAL_BULB = new DeferredSoundType(
            1.0F,
            1.5F,
            CSoundEvents.METAL_BULB_BREAK,
    ...
    public static final DeferredSoundType NETHERITE_GRATE = new DeferredSoundType(
            1.0F,
            1.0F,
    ...
    public static final DeferredSoundType NETHERITE_WINDOW = new DeferredSoundType(
            1.0F,
            1.0F,
    ...
    public static final DeferredSoundType NETHERITE_BULB = new DeferredSoundType(
            1.0F,
            1.0F,
            CSoundEvents.NETHERITE_BULB_BREAK,
