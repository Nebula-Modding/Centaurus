...
public class CSoundDefinitionsProvider extends SoundDefinitionsProvider {
    ...
    public void registerSounds() {
        ...
        add(CSounds.NETHERITE_BULB_PLACE, subtitle("block.generic.place").with(sound("block/netherite_bulb/place1"), sound("block/netherite_bulb/place2"), sound("block/netherite_bulb/place3"), sound("block/netherite_bulb/place4")));
